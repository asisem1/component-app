                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($subCategory->image)
                                                        <img src="{{ Storage::url($subCategory->image) }}" alt="Category Image" width="50" height="50">
                                                    @else
                                                        <span>No image</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="#" onlick="deleteSubCategory({{ $subCategory->id }})" class="text-danger w-4 h-4 mr-1">
